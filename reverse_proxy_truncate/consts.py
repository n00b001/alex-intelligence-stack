...
@dataclass
class Config:
    base_url: str = os.getenv("BASE_URL", "http://hades-ubuntu.arpa:8124")
    port: int = int(os.getenv("PORT", "8123"))
    context_length: int = int(os.getenv("CONTEXT", "62000"))
    max_new_tokens: int = int(os.getenv("MAX_NEW_TOKENS", "32000"))
    ...
    condense_retry_attempts: int = int(os.getenv("CONDENSE_RETRY_ATTEMPTS", "100"))
